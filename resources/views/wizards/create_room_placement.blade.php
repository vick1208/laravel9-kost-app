<div class="modal fade" id="create_room_placement_wizard" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tempatkan Penghuni</h5>
        ...
        <form action="/placements" method="post">
          ...
          <div class="mb-3 row gap-2">
            <div class="col-form-label">
              ...
              <a href="/placements" class="btn btn-sm btn-danger col-sm-3">Batal</a>
            </div>
          </div>
        </form>
      </div>
